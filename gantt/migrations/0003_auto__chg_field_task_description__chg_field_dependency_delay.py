...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'gantt_task', 'description', self.gf('django.db.models.fields.TextField')(max_length=255))

        # Changing field 'Dependency.delay'
        db.alter_column(u'gantt_dependency', 'delay', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Task.description'
        db.alter_column(u'gantt_task', 'description', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

        # Changing field 'Dependency.delay'
        db.alter_column(u'gantt_dependency', 'delay', self.gf('django.db.models.fields.FloatField')())
